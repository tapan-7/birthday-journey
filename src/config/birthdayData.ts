...
export const birthdayData: BirthdayConfig = {
  ...
  landingTitle: "Happy Birthday, Aanya ✨",
  landingSubtitle: "A cinematic journey through our favorite memories, inside jokes, and everything in between.",
  bypassUnlockText: "Tap to Unlock the Magic ✨",

  chapters: [
    { id: 1, title: "1. THE BEGINNING", sub: "Memory Constellation", description: "Swim into where it all began... The first 'hi', the first laugh, the first memory.", glow: "blue" },
    { id: 2, title: "2. CHAOS ZONE", sub: "Floating Memories", description: "All the crazy, random, funny, stupid & unforgettable moments.", glow: "purple" },
    { id: 3, title: "3. DEEPER THAN WORDS", sub: "Memories & Whispers", description: "The moments that meant everything. The words we never said out loud.", glow: "pink" },
    { id: 4, title: "4. LETTERS FROM ME", sub: "Gold Envelope", description: "Open letters, voice notes and words from my heart.", glow: "amber" },
    { id: 5, title: "5. WISHING WELL", sub: "Throw a Wish", description: "A magical wishing well. Make a wish and watch it drop.", glow: "rose" },
    { id: 6, title: "6. OUR LITTLE WORLD", sub: "Hidden Surprise", description: "A cozy ambient room built on memories, chaos & love.", glow: "teal" }
  ],
  ...
  vinylCrackleUrl: "https://assets.mixkit.co/active_storage/sfx/2568/2568-84.wav", // Vinyl crackle sample
  paperFlipUrl: "https://assets.mixkit.co/active_storage/sfx/1487/1487-84.wav", // paper flip/rustle
  cameraShutterUrl: "https://assets.mixkit.co/active_storage/sfx/1258/1258-84.wav", // camera shutter click
  ...
  funMemories: [
    {
      ...
      caption: "The time you tried to pay with your gym membership card and didn't realize for 5 full minutes.",
      position: { x: 10, y: 15 },
      rotation: -6
    },
    {
      ...
      caption: "Laughing so hard that tea literally came out of your nose. Still the highlight of my year.",
      position: { x: 50, y: 5 },
      rotation: 8
    },
    {
      ...
      caption: "You can sleep in a loud club, in a moving car, or standing up. It's honestly a superpower.",
      position: { x: 25, y: 50 },
      rotation: -4
    },
    {
      ...
      caption: "'I'm running late' autocorrected to 'I'm eating slate'. Now we say it every single time.",
      position: { x: 65, y: 55 },
      rotation: 5
    }
  ],
  ...
  emotionalMemories: [
    {
      id: "em-1",
      image: "https://images.unsplash.com/photo-1481841587457-5c99fcb6b7dd?w=800&auto=format&fit=crop&q=80",
      quote: "You probably don't realize how important you are to people.",
      story: "In a world where everyone is constantly busy, you showed up. You listened when I felt small, and you reminded me of who I was when I forgot. That is your magic."
    },
    {
      id: "em-2",
      image: "https://images.unsplash.com/photo-1482849737880-498de71dda8d?w=800&auto=format&fit=crop&q=80",
      quote: "Ordinary days became less ordinary because of you.",
      story: "We don't need fancy parties or grand adventures. Just sitting in your room, listening to music, and talking about life makes me feel incredibly lucky to have you."
    }
  ],
  ...
  hiddenSecret: {
    ...
    letterContent: "If you found this, it means you're nosey... but that's why we're friends! Seriously though, thank you for being you. Here's a little secret: I always count myself lucky to have met someone who shares my exact level of brain rot. Keep shining, you beautiful nerd.",
    bloopers: [
      { title: "Roast #1", text: "You still text in lowercase to look 'aesthetic' but type in all caps when you get excited." },
      { title: "Roast #2", text: "Your Spotify Wrapped is 90% sad songs even when you're perfectly happy." },
      { title: "Fact", text: "You are the strongest person I know, and I am so proud of you." }
    ]
  },
  ...
  ending: {
    ...
    subText: "Thank you for every laugh, every moment, and every memory. Happy Birthday once again ✨"
  }
};
